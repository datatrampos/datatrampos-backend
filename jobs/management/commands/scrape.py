        ...
        for company in GUPY_URLs:
            ...
            try:
                c = self.getCompanyInfo(
                    soup=bs, company_url=company['website'], company_name=company['company_name']
                )
            except Exception as e:
                print(e)
